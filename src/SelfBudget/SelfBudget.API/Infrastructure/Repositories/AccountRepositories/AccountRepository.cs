...
namespace SelfBudget.API.Infrastructure.Repositories.AccountRepositories;
...
public class AccountRepository : IAccountRepository
{
    ...
    public async Task<ICollection<Account>> GetAccountsByUserAsync(Guid userId, CancellationToken cancellationToken)
    {
